...
const ModuleRiskChart = ({ data }) => {
  if (!data || !data.module_breakdown) {
    return (
      <Card>
        <CardContent>
  ...
  const chartData = Object.entries(data.module_breakdown).map(([module, stats]) => ({
    module,
...
export default ModuleRiskChart
